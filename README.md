...
Recruiters upload Job Descriptions and CVs. The system uses Gemini embeddings (`gemini-embedding-001`) and semantic search to surface the best candidates with human-readable explanations generated by `gemini-3.6-flash`.
...
## API Cost Estimate (Gemini, August 2026)

**Models in use:**
- Text generation & extraction: `gemini-3.6-flash`
- Embeddings: `gemini-embedding-001`

| Task | Gemini 3.6 Flash | Gemini 3.5 Flash-Lite (budget) |
|------|-----------------|--------------------------------|
| Parsing 10 JDs | ~$0.28 | ~$0.05 |
| Parsing 10 CVs | ~$0.38 | ~$0.06 |
| Embedding 100 documents | ~$0.01 | ~$0.01 |
| 100 AI explanations/day | ~$0.42/day | ~$0.07/day |
| **Monthly total (moderate usage)** | **~$9–35/month** | **~$1.50–5.50/month** |

> See full token & cost analysis: [token_cost_analysis_EN.md](docs/token_cost_analysis_EN.md)
